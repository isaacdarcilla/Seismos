...
public class Seismos_pde extends PApplet {
 ...
 float inByte1 = PApplet.parseFloat(temp1+(char)9); 
 inByte1 = map(inByte1, -80,80, 0, height-80);
 float inByte2 = PApplet.parseFloat(temp2+(char)9); 
 inByte2 = map(inByte2,-80,80, 0, height-80);
 float inByte3 = PApplet.parseFloat(temp3+(char)9); 
 ...
 //ploting graph window, unit 
  ...
  fill(0,00,255);
  textAlign(RIGHT);
  xmargin("Seismos by Team Engineers",200,100); 
 ...
 public void Line(int x1, int y1, int x2, int y2)
 {
  ...
  public void ymargin(String value, int x1, int y1)
 {
   ...
   public void xmargin(String value, int x1, int y1)
 {
 ...
 public void Text(String value, int x1, int y1)
 {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Seismos" };
    if (passedArgs != null) {
